        ...
        <v-col class="d-flex fill-height flex-column">
            ...
            <v-row style="width: 100%;" class="mt-5">
             ...
             <v-row class="d-flex flex-column h-100 mt-10 mb-10">
                ...
                <el-table-column prop="id" label="档案编号" width="200"></el-table-column>
                ...
                <el-table-column prop="content" label="档案内容" width="100">
                    <template #default="{ row }">
            ...
            >
                ...
                >
                    <el-row :gutter="20">
                        <el-col :span="12">
                            ...
                            <el-form-item label="档案标题" prop="title" required>
                                <el-input v-model="form.title" placeholder="请输入档案标题"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <!-- 发布单位 -->
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <!-- 档案类型 -->
                            <el-form-item label="档案类型" prop="type" required>
