  ...
  <v-container fluid class="ma-0 fill-height bg-grey-lighten-3">
    <v-col class="d-flex fill-height flex-column">
      <v-row class="flex-shrink-0 flex-grow-0" style="flex-basis: 0; overflow: visible;">
        <v-col>
          <SubpageTitle text="主页" icon="mdi-home" @drawerToggle="$emit('drawerToggle')"></SubpageTitle>
        </v-col>
      </v-row>
      <v-row style="flex-basis: 0; overflow: hidden;">
        <v-col class="fill-height d-flex" cols="4">
          <v-sheet rounded="lg" class="d-flex flex-column" style="width: 100%;">
            <div class="d-flex">
              <h1 class="ml-5 mt-4 text-h5">待办事项</h1>
            </div>
            <div class="d-flex flex-shrink-0 flex-grow-1 justify-center align-center">
              <div class="text-center">
                <v-icon icon="mdi-calendar-check-outline" color="grey-lighten-1" style="font-size: 5rem;"></v-icon>
                <label class="d-block mt-1 text-grey-lighten-1">暂无事项</label>
              </div>
            </div>
          </v-sheet>
        </v-col>
        <v-col class="fill-height d-flex" cols="8">
          <ListCard title="系统公告" :list="xtgg"></ListCard>
        </v-col>
      </v-row>
      <v-row style="flex-basis: 0; overflow: hidden;">
        <v-col class="fill-height d-flex flex-column" cols="7">
          <v-row class="flex-shrink-0 flex-grow-0" style="flex-basis: 0; overflow: visible;">
            <h1 class="ml-5 mt-2 text-h5">支部中心</h1>
          </v-row>
          <v-row style="flex-basis: 0; overflow: hidden;">
            <v-carousel height="100%" cycle hide-delimiter-background :show-arrows="false">
              <v-carousel-item>
                <div class="d-flex fill-height align-stretch pt-3 pb-10 ">
                  <v-sheet rounded="lg"
                    class="flex-grow-1 d-flex align-start flex-column ma-3 elevation-8 py-5 pl-5 pr-10">
                    <IconParty class="mb-5" style="height: 70px;"></IconParty>
              ...
              <v-carousel-item>
                <div class="d-flex fill-height align-stretch pt-3 pb-10 ">
                  <v-sheet rounded="lg"
                    class="flex-grow-0 flex-shrink-0 d-flex align-start flex-column ma-3 elevation-8 py-5 pl-5 pr-10">
                    <IconParty class="mb-5" style="height: 70px;"></IconParty>
                    <h1 class="text-h3 font-weight-bold ">000
                      <v-label>人</v-label>
                    </h1>
        ...
        <v-col class="fill-height d-flex" cols="5">
          <ListCard title="学习样板" :list="xxyb"></ListCard>
        </v-col>
      </v-row>
    </v-col>
  </v-container>
