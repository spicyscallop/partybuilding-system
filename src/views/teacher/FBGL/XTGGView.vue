        ...
        <v-col class="d-flex fill-height flex-column">
                    ...
                    <v-col cols="10">
                        <v-row>
                            <v-col cols="7" class="d-flex align-center">
                                <span style="white-space: nowrap; min-width: 60px;">公告名称</span>
                                <el-input style="margin-left: 20px; width: 100%;" v-model="queryItems.title" placeholder="请输入内容"></el-input>
                            </v-col>
                            <v-col cols="5" class="d-flex align-center">
                                <span style="white-space: nowrap; min-width: 60px;">公告编号</span>
            ...
            <v-row style="width: 100%;" class="mt-5">
				<div style="display: flex; width: 100%; justify-content: flex-end;">
						<el-button class="redBtn" style="border-color: #A5A5A5;" @click="handleAdd">新增公告</el-button>
						<el-button class="whiteBtn" style="border-color: #A5A5A5;" @click="handleBatchDelete">删除公告</el-button>
				</div>
			</v-row>
             <v-row class="d-flex flex-column h-100 mt-10 mb-10">
                ...
                <!-- 公告编号 -->
                <el-table-column prop="id" label="公告编号" width="200"></el-table-column>
                <!-- 公告名称 -->
                ...
                <!-- 公告类型 -->
                <el-table-column prop="type" label="公告类型" width="100"></el-table-column>
                <!-- 状态 -->
                <el-table-column label="状态" width="100">
                    <template #default="{ row }">
                        <span :style="{ color: getStatus(row) === '未更改' ? 'red' : 'black' }">
                        {{ getStatus(row) }}
                        </span>
                    </template>
                </el-table-column>
