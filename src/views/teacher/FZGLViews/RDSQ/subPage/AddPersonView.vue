    ...
    <v-container fluid class="ma-0 fill-height" style="background-color: #ffffff;">
            ...
            <v-row style="width: 100%;">
                <v-col cols="6">
                    <div style="display: inline-block;">
                        ...
                        <div>
                            <input placeholder="四个字名；四个字名；" v-model="props.formData.talkerName"
                                :class="{ disableInput: isEditPage, customInput: !isEditPage }" :disabled=isEditPage
                                style="width: 400px;">
                        </div>
                    </div>
                </v-col>
                <v-col cols="6">
                    <div style="display: inline-block;">
                        ...
                        <div>
                            <el-date-picker v-model="props.formData.applyTime" type="date" placeholder="Pick a day"
            ...
            <v-row style="width: 100%;">
                <v-col style="margin-left: 10px;" cols="6">
                    <div style="display: inline-block;">
                        ...
                        <div>
                            <el-date-picker v-model="props.formData.talkerTime" type="date" placeholder="Pick a day"
        ...
        <v-row style="height: 20%;width: 100%;">
            ...
            <v-col cols="5">
                ...
                <el-select v-model="props.formData.changeToPhase" placeholder="更改发展阶段" size="large" style="width: 150px;float: right;">
