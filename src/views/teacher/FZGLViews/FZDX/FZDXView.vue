                ...
                <div
                    ...
                    <v-col cols="10">
                        ...
                        <span style="margin-left: 30px;">姓名</span><input placeholder="    请输入姓名"  v-model="queryItems.name"
                            style=" margin-left:10px;background-color: white;font-size: 12px;height: 25px;width: 10%;">
                        <span style="margin-left: 30px;">发展对象确认时间</span>
                        <!-- <el-button></el-button> -->
            ...
            <v-row class="d-flex flex-column h-100">
                ...
                <div class="flex-grow-1 overflow-auto">
                    <el-table ref="multipleTable" :data="tableData" max-height="80vh"
                        ...
                        <el-table-column v-if="visList[2]" prop="determinationTime" label="发展对象确定时间" align='center'>
                        </el-table-column>
                        <el-table-column v-if="visList[3]" prop="filingTime" label="发展对象备案时间" align='center'>
                        </el-table-column>
                        <el-table-column v-if="visList[4]" prop="introducer" label="入党介绍人" align='center'>
                        </el-table-column>
                        <el-table-column v-if="visList[5]" prop="tableSubmissionTime" label="《入党对象政治审查综合表》提交时间" align='center'>
                        </el-table-column>
                        <el-table-column v-if="visList[6]" prop="reportSubmissionTime" label="思想汇报提交时间" align='center'>
                        </el-table-column>
                    </el-table>
                </div>
            </v-row>
...
const checkedCols = ref(['学工号', '姓名', '发展对象确定时间', '发展对象备案时间', '入党介绍人', '《入党对象政治审查综合表》提交时间', '思想汇报提交时间']);
const colNames = ref(['学工号', '姓名', '发展对象确定时间', '发展对象备案时间', '入党介绍人', '《入党对象政治审查综合表》提交时间', '思想汇报提交时间']);
...
const tableData = ref([
    {
        userId: '22351006',
        name: '郭宗豪',
        determinationTime: "2023-03-12",
        filingTime: "2023-03-12",
        introducer: "FASERFW",
        tableSubmissionTime: "2023-03-12",
        reportSubmissionTime: "2023-03-12",
    },
]);
