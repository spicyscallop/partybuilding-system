            ...
            <v-row v-if="!goTo.visiblePersonView" class="d-flex flex-column h-100">
                ...
                <div class="flex-grow-1 overflow-auto">
                    <el-table ref="multipleTable" :data="tableData" max-height="80vh"
                        ...
                        <el-table-column v-if="visList[2]" prop="contactTrainer" label="联系培养人" align='center'>
                        </el-table-column>
                        <el-table-column v-if="visList[3]" prop="reportSubmissionTime" label="思想汇报提交时间" align='center'>
                        </el-table-column>
                        <el-table-column v-if="visList[4]" prop="confirmationTime" label="积极分子确认时间" align='center'>
                        </el-table-column>
                        <el-table-column v-if="visList[5]" prop="tableSubmissionTime" label="《入党积极分子-考察登记表》提交时间" align='center'>
                        </el-table-column>
                        <el-table-column v-if="visList[6]" prop="participationTime" label="党校参与培训时间" align='center'>
                        </el-table-column>
                    </el-table>
                </div>
            </v-row>
...
const checkedCols = ref(['学工号', '姓名', '联系培养人', '思想汇报提交时间', '积极分子确认时间', '《入党积极分子-考察登记表》提交时间', '党校参与培训时间']);
const colNames = ref(['学工号', '姓名', '联系培养人', '思想汇报提交时间', '积极分子确认时间', '《入党积极分子-考察登记表》提交时间', '党校参与培训时间']);
