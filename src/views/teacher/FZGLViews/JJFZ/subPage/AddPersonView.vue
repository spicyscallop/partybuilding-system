        ...
        <v-row style="background-color: #f7f7f7; height: 60%;padding: 20px;border-radius: 20px;">
            <v-row style="width: 100%;">
                <v-col cols="6">
                    <div style="display: inline-block;">
                        ...
                        <div>
                            <el-date-picker v-model="localFormData.tyTime" type="date" placeholder="yyyy-mm-dd"
                ...
                <v-col cols="6">
                    <div style="display: inline-block;">
                        ...
                        <div>
                            <el-date-picker v-model="localFormData.confirmationTime" type="date" placeholder="yyyy-mm-dd"
                                size="large" style="width: 400px;padding-left: 10px;" value-format="YYYY-MM-DD"/>
                        </div>
                    </div>
                </v-col>
                <v-col spans="6">
                    ...
                    <div>
                        <el-date-picker v-model="localFormData.participationTime" type="date" placeholder="系统自动接入" size="large" disabled
            ...
            <v-row style="width: 100%;">
                <v-col cols="6">
                    ...
                    <div>
                        <input class="customInput" placeholder="四个字名；四个字名" v-model="localFormData.contactTrainer"
                ...
                <v-col cols="3" >
                    ...
                    <div>
                        <el-date-picker v-model="localFormData.reportSubmissionTime" type="date" placeholder="yyyy-mm-dd" size="large" 
...
const choosePersons = () =>{
    ...
    localFormData.value.contactTrainer = names
...
const addPerson = ()=>{
    ...
    // 由于没有党校培训时间，加上的默认值
    if(!localFormData.value.participationTime){
        localFormData.value.participationTime = '2021-09-10'
    }
