            ...
            <v-row v-if="!goTo.visiblePersonView" class="d-flex flex-column h-100">
                ...
                <div class="flex-grow-1 overflow-auto">
                    <el-table ref="multipleTable" :data="tableData" max-height="80vh" :key="tableKey"
                        ...
                        <el-table-column v-if="visList[2]" prop="fzdxqdTime" label="发展对象确定时间" align='center'>
                        </el-table-column>
                        <el-table-column v-if="visList[3]" prop="fzdxbanTime" label="发展对象备案时间" align='center'>
                        </el-table-column>
                        <el-table-column v-if="visList[4]" prop="rdjsr" label="入党介绍人" align='center'>
                        </el-table-column>
                        <el-table-column v-if="visList[5]" prop="dxpxTime" label="党校培训班参与时间" align='center'>
                        </el-table-column>
                        <el-table-column v-if="visList[6]" prop="rddxzhbTime" label="《入党对象政治审查综合表》提交时间" align='center'>
                        </el-table-column>
                        <el-table-column v-if="visList[7]" prop="sixhbTime" label="思想汇报提交时间" align='center'>
                        </el-table-column>
                        <el-table-column v-if="visList[8]" prop="qzyjdcbTime" label="《群众意见调查表》提交时间" align='center'>
                        </el-table-column>
                        <el-table-column v-if="visList[9]" prop="bzrdsyjTime" label="《班主任导师意见》提交时间" align='center'>
                        </el-table-column>
                    </el-table>
                </div>
            </v-row>
...
import EditPersonView from '@/views/partyBranchManager/FZGLViews/FZDX/subPage/EditPersonView.vue'
...
const checkedCols = ref(['学工号', '姓名', '发展对象确定时间', '发展对象备案时间', '入党介绍人', '党校培训班参与时间','《入党对象政治审查综合表》提交时间','思想汇报提交时间','《群众意见调查表》提交时间','《班主任导师意见》提交时间']);
const colNames = ref(['学工号', '姓名', '发展对象确定时间', '发展对象备案时间', '入党介绍人', '党校培训班参与时间','《入党对象政治审查综合表》提交时间','思想汇报提交时间','《群众意见调查表》提交时间','《班主任导师意见》提交时间']);
const visList = ref([true, true, true, true, true, true, true, true, true, true]);
...
const tableData = ref([
    {
        userId: '22351006',
        name: '郭宗豪',
        fzdxqdTime: '2021-09-10',
        fzdxbanTime: '2021-09-10',
        rdjsr: '鲁兴，毛加油',
        dxpxTime: '2021-09-10',
        rddxzhbTime: '2021-09-10',
        sixhbTime: '2021-09-10',
        qzyjdcbTime: '2021-09-10',
        bzrdsyjTime: '2021-09-10',
