    ...
    <v-container fluid class="ma-0 fill-height" style="background-color: #ffffff;">
        ...
        <v-row class="d-flex justify-space-around mb-6" style="height: 10%;background-color: #ffffff;margin-top: 20px;">
            ...
            <v-col cols="4">
                ...
                <el-select v-model="localFormData.isCommunistYouthLeagueMember" :placeholder="placeholder" size="large"
                    style="width: 200px" :disabled="isEditPage">
        ...
        <v-row style="background-color: #f7f7f7; height: 60%;padding: 20px;border-radius: 20px;">
            <v-row style="width: 100%;margin-top: 20px;">
                <v-col>
                    ...
                    <el-date-picker v-model="localFormData.applyTime" type="date" placeholder="点击选择时间" size="large"
            ...
            <v-row style="width: 100%;margin-top: 30px;">
                <v-col>
                    ...
                    <el-date-picker v-model="localFormData.talkerTime" type="date" placeholder="点击选择时间" size="large"
                        style="width: 620px;margin-left: 100px;" />
                </v-col>
            </v-row>
            <v-row style="width: 100%;margin-top: 30px;">
                <v-col cols="6">
                    <span style="margin-left: 0px;">谈话人</span>
                    <input class="customInput" placeholder="" v-model="localFormData.talkerName"
                        @click="clickTalkersInput" style="width: 400px;margin-left: 20px;">
                </v-col>
                <v-col cols="6">
                    <span style="margin-left: 0px;">是否满足推优条件</span>
                    <input class="disableInput" placeholder="" v-model="localFormData.isSatisfy"
...
const choosePersons = () =>{
    ...
    localFormData.value.talkerName = names
