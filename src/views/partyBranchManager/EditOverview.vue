    ...
    <v-container fluid class="ma-0">
      <v-col style="height: 100%" class="d-flex flex-column justify-start">
        <v-row class="flex-shrink-0 flex-grow-0" style="flex-basis: 0; overflow: visible;">
          <v-col>
            <SubpageTitle text="编辑支委概况" icon="mdi-pencil" @drawerToggle="$emit('drawerToggle')"></SubpageTitle>
          </v-col>
        </v-row>
            ...
            <v-form ref="form" v-model="valid" class="fill-height">
              ...
              <div class="mb-6">
                <div class="d-flex align-center mb-3">
                  ...
                  <span class="text-h6 font-weight-bold" style="color: red;">支委简介</span>
                </div>
                <v-textarea
              ...
              <div class="mb-6 flex-grow-1">
                <div class="d-flex align-center mb-3">
                  <v-icon color="red" class="mr-2">mdi-seal-variant</v-icon>
                    <span class="text-h6 font-weight-bold" style="color: red;">支委荣誉</span>
                  <v-spacer></v-spacer>
                  <v-btn
                    color="primary"
                    variant="text"
